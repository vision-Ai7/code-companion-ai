    ...
    <div className="space-y-4">
      ...
      >
        {preview ? (
            ...
            {isProcessing && (
              <div className="absolute inset-0 bg-background/80 backdrop-blur-sm flex items-center justify-center rounded-lg">
                <div className="flex flex-col items-center gap-3">
                  ...
                  <span className="text-sm text-muted-foreground">Extracting code...</span>
                </div>
              </div>
            )}
            <Button
          ...
          <label className="flex flex-col items-center justify-center gap-4 min-h-[200px] cursor-pointer">
            <div className="p-4 rounded-full bg-primary/10 text-primary animate-pulse-slow">
              <Upload className="h-8 w-8" />
            </div>
            <div className="text-center">
              <p className="text-lg font-medium">Drop your code image here</p>
